...
//         await axios.put(`${API_BASE_URL}/admin/update/${currentAdminId}`, data);
//         toast({
//           title: "Success!",
...
//     try {
//       await axios.delete(`${API_BASE_URL}/admin/DestroyAdmin/${email}`);
//       toast({
//         title: 'Success',
...
//         <Card>
//           <CardHeader>
//             <CardTitle>{editMode ? "Edit Admin" : "Add Admin"}</CardTitle>
//             <CardDescription>
//               {editMode ? "Update admin details" : "Create a new admin with required permissions"}
//             </CardDescription>
//           </CardHeader>
...
//                       <TableHead>Agent Operation</TableHead>
//                       <TableHead>Agent Product</TableHead>
//                       <TableHead>Supplier Account</TableHead>
//                       <TableHead>Supplier Operation</TableHead>
...
//                           <TableCell>{renderPermissionBadge(admin.Agent_account)}</TableCell>
//                           <TableCell>{renderPermissionBadge(admin.Agent_operation)}</TableCell>
//                           <TableCell>{renderPermissionBadge(admin.Agent_product)}</TableCell>
//                           <TableCell>{renderPermissionBadge(admin.Supplier_account)}</TableCell>
//                           <TableCell>{renderPermissionBadge(admin.Supplier_operation)}</TableCell>
//                           <TableCell>{renderPermissionBadge(admin.Supplier_product)}</TableCell>
//                           <TableCell>
...
//       if (editMode && currentAdminId) {
//         // Update existing admin
//         await axios.put(`${API_BASE_URL}/admin/UpdateAdmin/${currentAdminId}`, data);
//         toast({
//           title: "Success!",
//           description: "Admin updated successfully.",
//         });
