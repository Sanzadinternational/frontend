...
//                             <Button
//                               variant="ghost"
//                               onClick={() => requestSort("booking.id")}
//                               className="p-0 hover:bg-transparent"
//                             >
//                               IDs
//                               <ArrowUpDown className="ml-2 h-4 w-4" />
...
//   TableRow,
// } from "@/components/ui/table";
// import { Search, ArrowUpDown, Loader2, Check, X, Clock, ChevronDown, ChevronUp, MoreHorizontal } from "lucide-react";
// import { Badge } from "@/components/ui/badge";
// import { format } from "date-fns";
...
import { Search, ArrowUpDown, Loader2, Check, X, Clock, ChevronDown, ChevronUp, Download } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { format } from "date-fns";
                                  ...
                                  <div className="p-4 space-y-4">
                                    ...
                                    <div className="flex justify-end gap-2">
                                      <Button
                                        ...
                                        disabled={downloadingInvoice === item.booking.id}
                                      >
