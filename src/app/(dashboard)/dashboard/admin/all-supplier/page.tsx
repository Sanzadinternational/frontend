...
//     `${API_BASE_URL}/admin/AllGetSuppliers`,
//     {
//       method: "GET",
//       headers: {
...
//   const response = await fetch(
//     `${API_BASE_URL}/admin/SupplierSingleView/${email}`,
//     {
//       method: "GET",
//       headers: {
//         "Content-Type": "application/json",
...
import { Eye, Check, X, Loader2, ChevronDown, ChevronUp } from "lucide-react";
...
export default function SupplierManagementPage() {
  ...
  return (
    <DashboardContainer>
      ...
      {/* Improved Supplier Details Dialog */}
      <Dialog open={!!selectedUser} onOpenChange={() => setSelectedUser(null)}>
