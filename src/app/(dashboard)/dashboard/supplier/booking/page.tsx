...
//   }>({
//     key: "booking.booked_at", // Default to sorting by booking date
...
// //added for driver email remainder
// // Add this function to send reminder emails
//   const sendDriverAssignmentReminder = async (booking: Booking) => {
//     if (!supplierEmail) {
...
//       toast({
//         title: "Reminder Sent",
//         description: "Email reminder has been sent about driver assignment",
//       });
//     } catch (error) {
...
//   // Add this useEffect to check for bookings needing driver assignment
//   useEffect(() => {
//     if (bookings.length === 0 || !supplierId || !supplierEmail) return;

//     bookings.forEach((item) => {
//       const booking = item.booking;
      
//       // Check if booking needs driver assignment and is within 24 hours
//       if (
...
//         if (!reminderSent) {
//           // Send reminder email
//           sendDriverAssignmentReminder(booking);
          
//           // Mark reminder as sent to avoid spamming
//           localStorage.setItem(`reminder-sent-${booking.id}`, "true");
          
//           // Set timeout to clear the reminder flag after 24 hours
//           setTimeout(() => {
//             localStorage.removeItem(`reminder-sent-${booking.id}`);
//           }, 24 * 60 * 60 * 1000); // 24 hours
//         }
//       }
//     });
//   }, [bookings, supplierId, supplierEmail]);
...
//                 variant="outline"
//                 size="sm"
//                 className="mt-1 text-red-700 border-red-300"
//                 onClick={() => {
//                   sendDriverAssignmentReminder(item.booking);
//                 }}
//               >
