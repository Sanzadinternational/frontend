...
const SearchResult = () => {
  // const { formData, vehicles } = useBooking(); // Access data from context
  // const { pickup, dropoff, pax, date, time } = formData;
  // const { formData = {}, vehicles = [] } = useBooking(); // Add fallback values
  // const { pickup = "N/A", dropoff = "N/A", pax = "N/A", date = "N/A", time = "N/A" } = formData;
  const { bookingData } = useBooking();
  // const { formData, responseData } = bookingData;
              ...
              <Card key={index} className="">
                ...
                <CardContent>
                  <div className="flex flex-col gap-5 md:flex-row justify-between">
                    <div className="w-auto md:w-[75%] flex flex-col md:flex-row md:justify-between">
                      <Image
                        src={vehicle.image||"/Sanzad-International-Hero-Image.jpg"} // Replace with vehicle image URL if available
                        width={250}
                        height={100}
                        alt={vehicle.brand}
                        className="rounded-sm"
